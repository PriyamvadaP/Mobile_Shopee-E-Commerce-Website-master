...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <?php echo "<img src='./assets/products/".$item['item_image']."'  class='img-fluid'>"; ?>
            ...
            <div class="col-sm-6 py-5">
                ...
                <table class="my-3">
                    ...
                    <tr class="font-rale font-size-14">
                        <!-- <td>Deal Price:</td> -->
                        <td class="font-size-20 text-danger">Rs.<span><?php echo $item['item_price'] ?? 0; ?></span><small class="text-dark font-size-12">&nbsp;&nbsp;</small></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <!-- <td>You Save:</td>
                        <td><span class="font-size-16 text-danger">$152.00</span></td> -->
                    </tr>
                    <h6 class="font-rubik my-3">Product Description</h6>
                      <span class="text_len">
                        <?php
                           $select_query = "Select item_desc from `product` where item_id=$item_id";
